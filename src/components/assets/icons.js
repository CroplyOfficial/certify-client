...
const Hide = ({width="1.5rem", id="", stroke="black", onClick=() => {}}) => {
   return (
      <svg width={width}  onClick={onClick} id={id} stroke={stroke ? stroke : "black"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.67969 3L21.6797 19" stroke={stroke} stroke-width="2" stroke-linecap="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.5273 4.95347C14.6173 4.69242 14.902 4.55377 15.163 4.6438C18.1487 5.67346 20.6974 7.98476 22.4582 11.0515C22.8657 11.7614 22.9629 12.5951 22.7497 13.3639C22.676 13.63 22.4004 13.786 22.1343 13.7122C21.8682 13.6384 21.7123 13.3629 21.7861 13.0968C21.9287 12.5822 21.8636 12.0244 21.591 11.5494C19.9254 8.6485 17.5505 6.52495 14.837 5.58916C14.5759 5.49914 14.4373 5.21453 14.5273 4.95347ZM8.28706 5.12941C8.39098 5.38525 8.26782 5.6769 8.01198 5.78082C5.51166 6.79643 3.32858 8.83236 1.76858 11.5495C1.41047 12.1732 1.41047 12.9398 1.76859 13.5636C4.05482 17.5456 7.66858 20.0565 11.6798 20.0565C14.5227 20.0565 17.159 18.7985 19.2712 16.6496C19.4648 16.4526 19.7813 16.4499 19.9783 16.6435C20.1752 16.8371 20.1779 17.1536 19.9844 17.3506C17.7167 19.6577 14.834 21.0565 11.6798 21.0565C7.21896 21.0565 3.31512 18.2656 0.90136 14.0615C0.366217 13.1294 0.366213 11.9837 0.901351 11.0516C2.551 8.17831 4.89163 5.96893 7.63565 4.85433C7.89149 4.75041 8.18314 4.87357 8.28706 5.12941Z" fill={stroke} /><circle cx="12" cy="12" r="3" stroke-width="2"></circle></svg>
   )
}
