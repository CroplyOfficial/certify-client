...
const Hide = ({width, id, fill, stroke, onClick}) => {
   return (
      <svg width={width ? width : "21"}  onClick={onClick} id={id} stroke={stroke ? stroke : "black"} viewBox="0 0 21 20" fill={stroke} xmlns="http://www.w3.org/2000/svg"><path d="M5.73303 2.5L19.0664 15.8333" strokeWidth="2" strokeLinecap="round"/><path fillRule="evenodd" clipRule="evenodd" d="M12.5547 3.93768C12.7347 3.41557 13.304 3.13828 13.8261 3.31834C16.4729 4.23114 18.6983 6.26675 20.2211 8.9191C20.6394 9.64768 20.739 10.5034 20.5203 11.2924C20.3727 11.8246 19.8217 12.1365 19.2895 11.9889C18.7573 11.8414 18.4454 11.2903 18.593 10.7581C18.6707 10.4776 18.6352 10.1737 18.4866 9.91492C17.1542 7.59423 15.2765 5.93412 13.174 5.20906C12.6519 5.02901 12.3746 4.45979 12.5547 3.93768ZM8.44637 4.05495C8.65421 4.56663 8.4079 5.14992 7.89622 5.35776C5.95477 6.14636 4.22745 7.7418 2.97974 9.91499C2.78458 10.2549 2.78458 10.6726 2.97975 11.0125C4.81054 14.2012 7.6528 16.1304 10.7332 16.1304C12.9207 16.1304 14.9739 15.1642 16.6433 13.4657C17.0305 13.0718 17.6636 13.0664 18.0575 13.4535C18.4514 13.8406 18.4568 14.4738 18.0697 14.8677C16.0893 16.8825 13.5434 18.1304 10.7332 18.1304C6.75357 18.1304 3.33115 15.6413 1.24529 12.0083C0.696072 11.0517 0.696068 9.87577 1.24528 8.91917C2.67229 6.43369 4.71472 4.49137 7.14355 3.50479C7.65524 3.29695 8.23853 3.54326 8.44637 4.05495Z" /><path d="M13.1576 9.85423C13.29 10.3808 13.2473 10.936 13.0361 11.4362C12.8249 11.9363 12.4566 12.3541 11.987 12.6264C11.5173 12.8987 10.9718 13.0107 10.4328 12.9455C9.89382 12.8803 9.39072 12.6415 8.99954 12.265C8.60835 11.8886 8.35033 11.395 8.26449 10.8589C8.17864 10.3229 8.26963 9.77343 8.52369 9.29365C8.77776 8.81388 9.18111 8.42984 9.67276 8.19959C10.1644 7.96935 10.7177 7.9054 11.2489 8.01742" strokeWidth="2"/></svg>
   )
}
