...
const TickBadge = ({width="1.5rem", id=""}) => {
   return (
      <svg width={width} id={id} viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
         <path d="M16.3817 4.00426C18.5152 1.41175 22.4848 1.41175 24.6183 4.00426C25.747 5.37574 27.4843 6.09536 29.2522 5.92367C32.594 5.59912 35.4009 8.40602 35.0763 11.7478C34.9046 13.5157 35.6243 15.253 36.9957 16.3817C39.5882 18.5152 39.5882 22.4848 36.9957 24.6183C35.6243 25.747 34.9046 27.4843 35.0763 29.2522C35.4009 32.594 32.594 35.4009 29.2522 35.0763C27.4843 34.9046 25.747 35.6243 24.6183 36.9957C22.4848 39.5882 18.5152 39.5882 16.3817 36.9957C15.253 35.6243 13.5157 34.9046 11.7478 35.0763C8.40602 35.4009 5.59912 32.594 5.92367 29.2522C6.09536 27.4843 5.37574 25.747 4.00427 24.6183C1.41175 22.4848 1.41175 18.5152 4.00427 16.3817C5.37574 15.253 6.09536 13.5157 5.92367 11.7478C5.59912 8.40602 8.40602 5.59912 11.7478 5.92367C13.5157 6.09536 15.253 5.37574 16.3817 4.00426Z" fill="black" fillOpacity="0.25" stroke="#91C69D" strokeWidth="4"/>
         <path d="M15.125 20.4099L18.9257 24.2106L26.5271 16.6092" stroke="#91C69D" strokeWidth="4" strokeLinecap="round"/>
      </svg>
   )
}
