...
const Step3 = ({nextStepFunc, passwordRef, confirmPasswordRef}) => {
    ...
    return (
        <Step>
            ...
            <div className="div2">
                <InputConfidInfo id="password" inputRef={passwordRef} err={passwordErr} placeholder="Password" strengthMeter required />
                <InputConfidInfo id="passwordConfirm" inputRef={confirmPasswordRef} err={confirmPasswordErr} placeholder="Confirm Password" required />
            </div>
            <div className="div3">
