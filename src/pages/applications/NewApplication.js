...
const NewApplication = ({theme}) => {
    ...
    const [userInput] = useState({
        "credential": userInputRefs.current["credential"] ? userInputRefs.current["credential"].value : "",
        ...
        <PageContentContainer>
            <MainContentContainer>
                <CustomMainContent contentTitle="View Application" componentRight={saveAppBtn}>
                    ...
                    <Select inputRef={el => userInputRefs.current["credential"] = el} placeholder="Credential" optionList={["Animal Agriculture License"]} />
