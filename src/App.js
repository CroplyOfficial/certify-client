...
import OrgUserSettings from "./pages/org/settings/UserSettings";
import RoleSettings from "./pages/org/settings/RoleSettings";
    ...
    <Router>
      <div className="App">
        ...
        <Switch>
          ...
          <Route
            component={ApplicationsOrg}
            exact
            path="/org/applications"
            title="Applications"
          />
          <Route
            component={NewApplicationOrg}
            path="/org/applications/new"
            title="New Application"
          />
          <Route
            component={ViewApplicationOrg}
            path="/org/applications/view"
          ...
          />
          <Route
            component={ViewTransactionTangle}
            path="/org/history/view"
            title="View Transaction Tangle"
          />

          <Route
            component={IdentityDashboard}
            path="/org/identity/dashboard"
            title="Identity Dashboard"
          />
          <Route
            component={IdentityScan}
            path="/org/identity/scan"
            title="Identity Scan"
          />
          <Route
            component={IdentityProfilesList}
            exact
            path="/org/identity/profilesList"
            title="Identity Profiles List"
          />
          <Route
            component={ViewProfile}
            path="/org/identity/profilesList/view"
            title="View Profile"
          />
          <Route
            component={AddCredentials}
            path="/org/identity/profilesList/addCredentials"
            title="Add Credentials"
          />
          <Route
            component={ProfileDomainSettings}
            path="/org/identity/profilesList/domainSettings"
            title="Profile Domain Settings"
          />
          ...
          <Route
            ...
            path="/org/credentials/new"
            title="New Credential"
          />
          <Route
            component={ViewCredential}
            path="/org/credentials/view"
            title="View Credential"
          />
          <Route
            component={IssueCredential}
            path="/org/credentials/issue"
          ...
          <Route
            component={GeneralSettingsOrg}
            path="/org/settings/general"
            title="General Settings"
          />
          <Route
            component={SecuritySettingsOrg}
            path="/org/settings/security"
            title="Security Settings"
          />
          <Route
            component={OrgUserSettings}
          ...
          />
          <Route
            component={NewApplicationUser}
            path="/user/applications/new"
            title="New Application"
          />
          <Route
            component={ViewApplicationUser}
            path="/user/applications/view"
            title="View Application"
          />
          ...
          <Route
            ...
            exact
            path="/user/publicProfile"
            title="Public Profile"
          />
          <Route
            component={ViewPublicProfile}
            path="/user/publicProfile/view"
